...
//---------------------------------------------------------------------------
 ...
 public InputStream getByteStream()
 {
  ...
  catch(IOException ex){sendError("getByteStream",ex.getMessage());}
  return null;
 }
 @Override
...
//---------------------------------------------------------------------------
 ...
 public String getStringData()
 {
  ...
  catch(UnsupportedEncodingException ex){sendError("getStringData",ex.getMessage());}
 ...
 public void setStringData(String stringData)
 {
  ...
  catch(UnsupportedEncodingException ex){sendError("setStringData",ex.getMessage());}
 }
//---------------------------------------------------------------------------

 ...
 * @author Anatol
 */
public class ADBFieldData extends AClass
{
//---------------------------------------------------------------------------
//---------------------------------------------------<   P R I V A T E   >---
//---------------------------------------------------------------------------
// private ABuffer FBuffer;
 private AMemory FMemory;
//---------------------------------------------------------------------------
 private void initialize()
 {
//  FBuffer=new ABuffer();
//  FBuffer.setParent(this);
  FMemory=new AMemory();
...
//---------------------------------------------------<    P U B L I C    >---
//---------------------------------------------------------------------------
 public ADBFieldData(){initialize();}
//---------------------------------------------------------------------------
 public ADBFieldData(final ADBFieldData value) throws AException
 {
  initialize();
  assign(value);
 }
//---------------------------------------------------------------------------
 public final void assign(final ADBFieldData value) throws AException
 {
...
//---------------------------------------------------------------------------
 public int WriteToBuffer(ABuffer buf,final ADBFieldInfo Info) throws AException
 {
...
//---------------------------------------------------------------------------
 int ReadFromBuffer(ABuffer buf,final ADBFieldInfo Info) throws AException
 {
  if(buf==null)
  {
  ...
  if(Info.isStatic())
  {
   ...
   if(Info.getType()!=ADBField.dbftVoid)                                        //??? ADBField.dbftVoid
   {

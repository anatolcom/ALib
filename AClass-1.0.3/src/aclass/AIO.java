...
//---------------------------------------------------------------------------
/**
  * Функция считывает файл ресурса с именем name, адрес которого указывается относительно раположения resource
  * если файл ненайден, а required = true, то вызывается исключение.<br/>
  * 

...
//  AClass.sendGlobalError(element.getClassName(),element.getMethodName(),msg,null);
  ...
  AClass.sendGlobalErrorEx(element.toString(), "", msg);
 }
//---------------------------------------------------------------------------
...
////  AClass.sendGlobalError(element.getClassName(),element.getMethodName(),msg,null);
//  StackTraceElement element = this.getStackTrace()[0];
//  AClass.sendGlobalErrorEx(element.toString(), "", msg + " : " + value);
// }
//---------------------------------------------------------------------------
 public AException(String msg, Exception ex)
 {
  ...
  if (ex == null)
  {
   AClass.sendGlobalErrorEx(element.toString(), "", msg + " and ex=null");
   return;
  }
...
//---------------------------------------------------------------------------
 public AException(Exception ex)
 {
  ...
  if (ex == null)
  {
   AClass.sendGlobalErrorEx(String.valueOf(element), "", "ex = null");
   return;
  }
  StackTraceElement[] elements = ex.getStackTrace();
  for (int q = 0; q < elements.length; q++)
  ...
  AClass.sendGlobalErrorEx(String.valueOf(element), "", ex.getMessage());
 }
//---------------------------------------------------------------------------
...
//   break;
//  }
//  AClass.sendGlobalErrorEx(element.toString(), "", ex.getMessage() + " : " + value);
// }
//---------------------------------------------------------------------------
}
